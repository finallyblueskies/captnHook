...
// ClientMsg is the standard message sent by clients of the alpacastream interface
...
// of the alpacastream interface
type ServerMsg struct {
	Stream string      `json:"alpacastream" msgpack:"alpacastream"`
